...
import { DataDia, HistorailPersonal, Marcajes, PuestoNomina } from '../../../models/Nomina';
         ...
         for(let item of data)
          {
            ...
            for(let dia of item.data)
              {
                    let incidenciasResultas = dia.incidencias.filter(x=> x.regbitacora != null && x.regbitacora.status == true).length;
