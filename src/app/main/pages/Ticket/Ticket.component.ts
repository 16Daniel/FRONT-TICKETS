...
import { StatusTK, TicketDB } from '../../../Interfaces/ticket';
...
constructor(private route: ActivatedRoute
  ,private http: HttpClient, private firestore:Firestore,private auth:Auth, private apiserv:ApiService, public cdr:ChangeDetectorRef,
...
) 
{
  ...
  getDepartamentos()
  {
   ...
   getdataTK()
   {
    this.apiserv.getTk(this.idt).subscribe({
      next: data => {
         this.itemtk = data[0]; 
       this.cdr.detectChanges();
      },
