...
import { NotificacionDB } from '../../Interfaces/Notificacion';
...
public items:MenuItem[] = []; 
  ...
  if(environment.production==true)
   ...
   {
     this.subscriptionnt = this.apiserv
    ...
    borrarNt(id:string)
    {
      this.apiserv.deleteDocument('Notificaciones',id);
    }
