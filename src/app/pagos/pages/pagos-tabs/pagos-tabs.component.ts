...
@Component({
  ...
  standalone: true,
  imports: [SideMenuComponent, CommonModule, TabViewModule, ShoppingAdminComponent, ViaticosTabComponent, BonosTabComponent, FondeoTarjetaTabComponent, GasolinaTabComponent],
