...
@Component({
  selector: 'app-subir-imagen-av-dialog-2',
  standalone: true,
  imports: [DialogModule, CommonModule],
  templateUrl: './subir-imagenes-av-dialog-2.component.html',
  styleUrl: './subir-imagenes-av-dialog-2.component.scss'
})
export class SubirImagenesAv2Component {
